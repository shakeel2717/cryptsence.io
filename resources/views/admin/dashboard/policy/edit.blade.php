            ...
            <div class="box">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.policy.store') }}" method="post">
                        ...
                        <div class="mt-5">
                            <input name="end_date" class="datepicker form-control w-56 " data-single-mode="true" value="{{ $policy->start_date }}">
                        </div>
                        <div>
                            <label class="mt-4">Bonus</label>
                            <div class="mt-2">
                                <input type="text" class="form-control" name="bonus" id="bonus"
                                    placeholder="Enter Bonus Amount %" value="{{ $policy->end_date }}">
                            </div>
                        </div>
