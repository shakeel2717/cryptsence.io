    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="box">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.policy.update',['policy' => $policy->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="title" id="title"
                                    placeholder="Enter Policy Title" value="{{ $policy->title }}">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                placeholder="Enter Policy Description">{{ $policy->description }}</textarea>
                            </div>
                        </div>
                        <label class="mt-4">Starting Date {{ $policy->start_date }}</label>
                        <div class="mt-5">
                            <input name="st_date" class="datepicker form-control w-56 " data-single-mode="true">
                        </div>
                        <label class="mt-4">End Date {{ $policy->end_date }}</label>
                        <div class="mt-5">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="bonus" id="bonus"
                                    placeholder="Enter Bonus Amount %" value="{{ $policy->bonus }}">
                            </div>
                        </div>
