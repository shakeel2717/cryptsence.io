        ...
        <div class="report-box-2 intro-y mt-12 mt-sm-5">
            <div class="box d-sm-flex">
                <div class="px-8 py-8 d-flex flex-column justify-content-center flex-1">
                    ...
                    <a href="{{ route('user.convert.index') }}" class="btn btn-outline-secondary position-relative justify-content-start rounded-pill mt-12">
                        Get CTSE Coin
                        <span class="w-8 h-8 position-absolute d-flex justify-content-center align-items-center bg-theme-1 text-white rounded-pill end-0 top-0 bottom-0 my-auto ms-auto me-0.5">
                            <i data-feather="arrow-right" class="w-4 h-4"></i> </span>
                    </a>
                </div>
                <div class="px-8 py-12 d-flex flex-column justify-content-center flex-1 border-top border-top-sm-0 border-start-sm border-gray-300 dark-border-dark-5 border-dashed">
                ...
                <div class="report-box zoom-in mt-12 mt-sm-5">
                    <div class="box p-5">
                        ...
                        <div class="report-box__total fs-3xl fw-medium mt-6">
                            {{ number_format(balance('CTSE', auth()->user()->id), 8) }}
                        </div>
                ...
                <div class="report-box zoom-in mt-12 mt-sm-5">
                    <a href="{{ route('admin.report.allStackingBounces') }}">
                        <div class="box p-5">
                            ...
                            <div class="report-box__total fs-3xl fw-medium mt-6">
                                {{ number_format(stakeBounsAll('CTSE', auth()->user()->id), 8) }}
                            </div>
...
<div class="row">
                ...
                <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                        ...
                        <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                            <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('assets/images/icons/statistic.png') }}">
                        </div>
                    </div>
                </div>
                <div class="intro-y">
    ...
    <div class="col-lg-4">
        ...
        <div class="g-col-12 g-col-md-6 g-col-xl-12 g-start-xl-1 g-row-start-xl-1 g-start-xxl-auto g-row-start-xxl-auto mt-6">
            <div class="intro-x d-flex align-items-center h-10">
                ...
                <button data-carousel="important-notes" data-target="prev" class="tiny-slider-navigator btn px-2 border-gray-400 dark-border-dark-3 text-gray-700 dark-text-gray-300 me-2">
                    <i data-feather="chevron-left" class="w-4 h-4"></i> </button>
                <button data-carousel="important-notes" data-target="next" class="tiny-slider-navigator btn px-2 border-gray-400 dark-border-dark-3 text-gray-700 dark-text-gray-300 me-2">
...
<div class="row">
    <div class="col-12 col-md-6 mt-6">
        <div class="intro-y d-block d-sm-flex align-items-center h-10">
            ...
            <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                <a href="{{ route('user.report.transactions.recent') }}" class="btn box d-flex align-items-center text-gray-700 dark-text-gray-300"> <i data-feather="file" class="d-none d-sm-block w-4 h-4 me-2"></i> Check all History </a>
            </div>
        </div>
            ...
            <div class="intro-x mt-5">
                <div class="box px-5 py-3 mb-3 d-flex align-items-center zoom-in">
                    <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                        <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('assets/images/coins/' . $transaction->coin->image) }}">
                    </div>
                    <div class="ms-4 me-auto">
                    ...
                    <div class="text-theme-{{ $transaction->sum == 'in' ? '9' : '6' }}">
                        {{ number_format($transaction->amount, 2) }} {{ $transaction->coin->symbol }}
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="col-md-6 mt-6">
        <div class="intro-y d-block d-sm-flex align-items-center h-10">
            ...
            <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                <a href="{{ route('user.report.transactions.allStackingBounces') }}" class="btn box d-flex align-items-center text-gray-700 dark-text-gray-300"> <i data-feather="file" class="d-none d-sm-block w-4 h-4 me-2"></i> Check all History </a>
            </div>
        </div>
        <div class="intro-y overflow-auto overflow-lg-visible mt-8 mt-sm-0">
    ...
    <div class="col-md-12 mt-6">
        <div class="intro-y d-block d-sm-flex align-items-center h-10">
            ...
            <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                <a href="{{ route('user.profile.recent.login') }}" class="btn box d-flex align-items-center text-gray-700 dark-text-gray-300"> <i data-feather="lock" class="d-none d-sm-block w-4 h-4 me-2"></i> Check all History </a>
            </div>
        </div>
        <div class="intro-y overflow-auto overflow-lg-visible mt-8 mt-sm-0">
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img alt="{{ env('APP_DESC') }}" class="tooltip rounded-circle" src="/assets/images/devices/{{ strtolower($login_history->device) }}.png" title="{{ $login_history->device }}">
                            </div>
                        ...
                        <form action="{{ route('user.referral.stack') }}" method="POST">
                            ...
                            <div class="modal-body grid columns-12 gap-4 gap-y-3">
                                <div class="g-col-12"> <label for="amount" class="form-label">Amount</label>
                                    <input id="amount" name="amount" type="text" class="form-control" value="{{ ReferralBalance(auth()->user()->id) }}" placeholder="Enter Amount you want to Send CTSE to Stack">
                                </div>
                            </div>
