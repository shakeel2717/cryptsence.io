...
<li>
    ...
    <ul class="{{ $mode == true ? 'side-' : '' }}menu__sub">
        ...
        <li>
            <a href="{{ route('user.report.transactions.withdrawals') }}" class="{{ $mode == true ? 'side-' : '' }}menu">
                <div class="{{ $mode == true ? 'side-' : '' }}menu__icon"> <i data-feather="corner-down-right"></i> </div>
                <div class="{{ $mode == true ? 'side-' : '' }}menu__title"> All Withdrawals </div>
            </a>
        </li>
        <li>
            <a href="{{ route('user.report.transactions.convert') }}" class="{{ $mode == true ? 'side-' : '' }}menu">
                <div class="{{ $mode == true ? 'side-' : '' }}menu__icon"> <i data-feather="corner-down-right"></i> </div>
                <div class="{{ $mode == true ? 'side-' : '' }}menu__title"> All convert </div>
            </a>
        </li>
        <li>
            <a href="{{ route('user.report.transactions.dailyProfit') }}" class="{{ $mode == true ? 'side-' : '' }}menu">
                <div class="{{ $mode == true ? 'side-' : '' }}menu__icon"> <i data-feather="corner-down-right"></i> </div>
