<ul class="nav nav-link-tabs flex-column flex-sm-row justify-content-center justify-content-lg-start" role="tablist">
    <li id="profile-tab" class="nav-item" role="presentation">
        <a href="{{ route('admin.profile.index') }}" class="nav-link px-0 me-sm-8 d-flex align-items-center active">
            <i class="w-4 h-4 me-2" data-feather="user"></i> My Profile </a>
    </li>
    <li id="change-password-tab" class="nav-item" role="presentation">
        <a href="{{ route('admin.profile.password.change') }}" class="nav-link px-0 me-sm-8 d-flex align-items-center">
    ...
    <li id="account-tab" class="nav-item" role="presentation">
        <a href="{{ route('admin.profile.recent.login') }}" class="nav-link px-0 me-sm-8 d-flex align-items-center">
            <i class="w-4 h-4 me-2" data-feather="shield"></i> Recent Login </a>
    </li>
</ul>
