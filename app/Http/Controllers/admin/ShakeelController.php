...
class ShakeelController extends Controller
{
    ...
    {
        return view('admin.dashboard.shakeel.index');
    }
    ...
    {
        return view('admin.dashboard.shakeel.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.shakeel.index')->with('success','Expense Entry Added');
