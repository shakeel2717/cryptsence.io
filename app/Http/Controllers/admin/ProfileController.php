...
class ProfileController extends Controller
{
    ...
    {
        return view('admin.dashboard.profile.change-password');
    }
    ...
    public function updatePassword()
    {
        ...
        if (Hash::check(request('cpassword'), auth()->user()->password)) {
            ...
            // redirecting to the profile page
            return redirect()->route('admin.profile.index')->withErrors('Current password is incorrect');
        }
    }
    ...
    public function recentLogin()
    {
        ...
        return view('admin.dashboard.profile.recentLogin', compact('histories'));
    }
