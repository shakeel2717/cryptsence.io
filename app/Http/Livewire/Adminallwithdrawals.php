...
final class Adminallwithdrawals extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return Transaction::query()->join('users', 'users.id', '=', 'transactions.user_id')->select('transactions.*', 'users.name')->where('transactions.type', 'withdraw');
    }
