...
final class AllNotification extends PowerGridComponent
{
    ...
    *
    * @return Builder<\App\Models\user\UserNotification>
    */
...
;
    ...
    */
     ...
     /**
     * PowerGrid UserNotification Action Buttons.
     *
    ...
    */
     ...
     /**
     * PowerGrid UserNotification Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($user-notification) => $user-notification->id === 1)
                ->hide(),
        ];
    }
    */
