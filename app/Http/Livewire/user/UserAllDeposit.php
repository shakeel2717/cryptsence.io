...
final class UserAllDeposit extends PowerGridComponent
{
    ...
    */
    ...
    {
        return Transaction::query()->where('user_id', auth()->user()->id)->join('coins', 'coins.id', '=', 'transactions.coin_id')->select('transactions.*', 'coins.symbol')->latest()->where('type', '=', 'deposit');
    }
