...
final class AllStakingReward extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return StakingBonus::query()
        ->join('users', 'users.id', '=', 'staking_bonuses.user_id')
        ->select('staking_bonuses.*', 'users.name')
        ->where('sum','in')
        ;
    }
